...
import (
	...
	"github.com/kxplxn/watermark-service/api/v1/pb/watermark"
...
func decodeGRPCGetRequest(_ context.Context, grpcReq any) (any, error) {
...
func decodeGRPCStatusRequest(_ context.Context, grpcReq any) (any, error) {
	req := grpcReq.(*watermark.StatusRequest)
	return endpoints.StatusRequest{TicketID: req.TicketID}, nil
}

func decodeGRPCWatermarkRequest(_ context.Context, grpcReq any) (any, error) {
	req := grpcReq.(*watermark.WatermarkRequest)
	return endpoints.WatermarkRequest{TicketID: req.TicketID, Mark: req.Mark}, nil
}

func decodeGRPCAddDocumentRequest(_ context.Context, grpcReq any) (any, error) {
...
func decodeGRPCServiceStatusRequest(_ context.Context, _ any) (any, error) {
	return endpoints.ServiceStatusRequest{}, nil
}

func decodeGRPCGetResponse(_ context.Context, grpcReply any) (any, error) {
...
func decodeGRPCStatusResponse(_ context.Context, grpcReply any) (any, error) {
